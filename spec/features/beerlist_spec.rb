...
describe "beerlist page" do
  ...
  it "lists the beers in alphabetical order", :js => true do
    visit beerlist_path
  ...
  it "lists styles in alphabetical order", :js => true do
    visit beerlist_path
    click_link "Style"
  ...
  it "lists breweries in alphabetical order", :js => true do
    visit beerlist_path
    click_link "Brewery"
